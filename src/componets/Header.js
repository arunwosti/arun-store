            ...
            <div className='row'>
                ...
                <div className='col-6'>
                    <p className='text-end text-white mb-0'>
                        Hotline: <a  className='text-white' href='tel: +977- 9830235602'>+977- 9830235602</a> 
                    </p>
                </div>
            </div>
        </div>
            ...
            <div className='row align-items-centre'>
                <div className='col-2'>
                    <h2 className='text-white'>
                        <Link className='text-white' to={""}>AStore</Link>
                    </h2>
                </div>
                <div className='col-5'>
                ...
                <div className='col-5'>
                    <div className='header-upper-links d-flex align-items-centre justify-content-between'>
                        <div>
